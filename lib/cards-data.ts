...
export const cards: CardType[] = [
  {
    ...
    description: "سقف تحويل يومي 50 مليون سنتيم، والشراء من أي موقع إلكتروني بسقف 500 مليون سنتيم شهرياً، مع رقم بطاقة ديناميكي (CVV متغير) لحماية عملياتك الكبيرة.",
